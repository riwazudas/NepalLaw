...
LAWS = [
    {"id": 18682, "name": "income_tax_act_2058_nepali.md", "title": "आयकर ऐन, २०५८"},
    {"id": 19408, "name": "income_tax_act_2058_english.md", "title": "Income Tax Act, 2058 (2002)"}
]
...
def extract_law(law_id, output_file, law_title):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        for item in top_level:
            ...
            item_id = item['id']
            # Avoid printing Nepali characters directly to avoid console encoding issues
