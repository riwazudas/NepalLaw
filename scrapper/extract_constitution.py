...
LAWS = [
    {"id": 36925, "name": "constitution_2072_english.md", "title": "Constitution of Nepal, 2072 (2015)"},
...
def fetch_all(parent_id):
    ...
    while True:
        ...
        try:
            ...
            print(f"Error fetching children of {parent_id} (page {page}): {e}")
            break
    return all_items

def extract_law(law_id, output_file, law_title):
    print(f"Starting extraction for Constitution ID: {law_id}...")
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        print(f"Found {len(parts)} parts/top-level items.")
        ...
        for part in parts:
            ...
            if articles:
                for article in articles:
                    ...
                    # Some parts have nested sub-levels (Chapters -> Articles)
